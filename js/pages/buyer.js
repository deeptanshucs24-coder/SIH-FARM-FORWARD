      ...
      <div class="bg-white rounded-2xl border border-outline p-6">
        <div class="flex items-start gap-4 mb-6">
          ...
          <div class="flex-1">
            ...
            <p class="text-on-surface-variant mt-1">Established 2008 · Indore, Madhya Pradesh</p>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div class="bg-surface rounded-xl p-3"><p class="text-xs text-on-surface-variant uppercase font-medium tracking-wider mb-1">Target Price</p><p class="font-bold text-on-surface">₹4,850/Qt</p></div>
      ...
      <div class="bg-white rounded-2xl border border-outline overflow-hidden">
        ...
        <table class="w-full text-left">
          ...
          <tbody class="divide-y divide-outline">
            <tr class="hover:bg-surface/30"><td class="px-6 py-4 text-sm text-on-surface-variant">Jun 12, 2024</td><td class="px-6 py-4 text-sm font-medium text-on-surface">Wheat</td><td class="px-6 py-4 text-sm text-on-surface">320 Qt</td><td class="px-6 py-4 text-sm font-bold text-on-surface">₹9,92,000</td><td class="px-6 py-4"><span class="inline-flex px-2 py-1 rounded-full text-xs font-semibold bg-success-bg text-success">Completed</span></td></tr>
            <tr class="hover:bg-surface/30"><td class="px-6 py-4 text-sm text-on-surface-variant">Mar 5, 2024</td><td class="px-6 py-4 text-sm font-medium text-on-surface">Soybean</td><td class="px-6 py-4 text-sm text-on-surface">480 Qt</td><td class="px-6 py-4 text-sm font-bold text-on-surface">₹22,08,000</td><td class="px-6 py-4"><span class="inline-flex px-2 py-1 rounded-full text-xs font-semibold bg-success-bg text-success">Completed</span></td></tr>
            <tr class="hover:bg-surface/30"><td class="px-6 py-4 text-sm text-on-surface-variant">Nov 18, 2023</td><td class="px-6 py-4 text-sm font-medium text-on-surface">Maize</td><td class="px-6 py-4 text-sm text-on-surface">200 Qt</td><td class="px-6 py-4 text-sm font-bold text-on-surface">₹4,20,000</td><td class="px-6 py-4"><span class="inline-flex px-2 py-1 rounded-full text-xs font-semibold bg-success-bg text-success">Completed</span></td></tr>
          </tbody>
        </table>
      </div>
    </div>
    ...
    <div class="w-full lg:w-[340px] space-y-4 shrink-0">
      <div class="rounded-2xl p-6 text-white" style="background:#1b4332">
        ...
        <div class="space-y-3 mb-5">
          <div class="bg-white/10 rounded-xl p-3"><p class="text-xs text-green-200 uppercase font-medium mb-1">Their Offer</p><p class="text-2xl font-bold">₹4,850 / Qt</p></div>
          <div class="bg-white/10 rounded-xl p-3"><p class="text-xs text-green-200 uppercase font-medium mb-1">Your Listed Price</p><p class="text-2xl font-bold">₹4,800 / Qt</p></div>
        </div>
        <div class="space-y-2">
          <button class="w-full py-3 bg-primary-light font-bold rounded-xl hover:bg-white transition-colors" style="color:#1b4332" onclick="alert('Offer ₹4,850/Qt accepted! Contract generated.')">Accept ₹4,850/Qt</button>
