export function render() {
  ...
  <div class="mb-6">
    ...
    <h2 class="text-3xl font-bold text-on-surface">Wheat — Price Analysis</h2>
    <p class="text-on-surface-variant mt-1">Track mandi prices, historical trends, and the best time to sell.</p>
  </div>
  <!-- Metric Cards -->
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    <div class="bg-white rounded-lg border border-outline p-4"><div class="flex items-start"><div class="bg-primary-light/50 p-2 rounded-md mr-3"><svg class="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></svg></div><div><p class="text-sm font-medium text-on-surface-variant">Current Best Price</p><div class="flex items-baseline mt-1"><span class="text-2xl font-bold text-on-surface">₹3,200</span><span class="text-sm text-on-surface-variant ml-1">/ Qt</span></div><p class="text-sm text-on-surface-variant">Delhi Mandi</p></div></div><div class="mt-4"><span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-success-bg text-success"><svg class="mr-1 h-3 w-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></svg>2.4% today</span></div></div>
    <div class="bg-white rounded-lg border border-outline p-4"><div class="flex items-start"><div class="bg-primary-light/50 p-2 rounded-md mr-3"><svg class="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></svg></div><div><p class="text-sm font-medium text-on-surface-variant">7-Day Average</p><div class="flex items-baseline mt-1"><span class="text-2xl font-bold text-on-surface">₹3,085</span><span class="text-sm text-on-surface-variant ml-1">/ Qt</span></div></div></div><div class="mt-4 text-right"><span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-success-bg text-success">3.7% vs last week</span></div></div>
    <div class="bg-white rounded-lg border border-outline p-4"><div class="flex items-start"><div class="bg-primary-light/50 p-2 rounded-md mr-3"><svg class="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/><path d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></svg></div><div><p class="text-sm font-medium text-on-surface-variant">Highest Nearby</p><div class="flex items-baseline mt-1"><span class="text-2xl font-bold text-on-surface">₹3,240</span><span class="text-sm text-on-surface-variant ml-1">/ Qt</span></div><p class="text-sm text-on-surface-variant">Jaipur Mandi</p></div></div><div class="mt-4 flex items-center text-xs text-on-surface-variant">240 km away</div></div>
    <div class="bg-white rounded-lg border border-outline p-4"><div class="flex items-start"><div class="bg-primary-light/50 p-2 rounded-md mr-3"><svg class="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></svg></div><div><p class="text-sm font-medium text-on-surface-variant">Predicted Price</p><div class="flex items-baseline mt-1"><span class="text-2xl font-bold text-on-surface">₹3,350</span><span class="text-sm text-on-surface-variant ml-1">/ Qt</span></div><p class="text-sm text-on-surface-variant">Expected in 7 days</p></div></div><div class="mt-4 text-right"><span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-success-bg text-success">Strong Buy Signal</span></div></div>
  </div>
  <!-- Chart + Right -->
  <div class="flex flex-col lg:flex-row gap-6">
    <div class="flex-1 flex flex-col gap-6">
      ...
      <div class="bg-white p-6 rounded-lg border border-outline shadow-sm">
        <div class="flex justify-between items-center mb-6">
          <h3 class="text-lg font-bold text-on-surface">Wheat Price Trend — Last 30 Days</h3>
        ...
        <p class="text-xs text-on-surface-variant mb-2">Price (₹ / Quintal)</p>
      ...
      <div class="bg-white rounded-lg border border-outline shadow-sm overflow-hidden">
        ...
        <table class="min-w-full divide-y divide-outline">
          <thead class="bg-gray-50"><tr>
            ...
            <th class="px-6 py-3 text-right text-xs font-medium text-on-surface-variant uppercase tracking-wider">Price (₹/Qt)</th>
    ...
    <div class="w-full lg:w-[320px] flex flex-col gap-6 shrink-0">
      ...
      <div class="rounded-lg shadow-sm p-6 text-white relative overflow-hidden" style="background:#1b4332">
        ...
        <h3 class="text-3xl font-bold mb-2">Hold for 3–5 days</h3>
        <p class="text-green-100 text-sm mb-6">Expected upside: ₹120–₹150 / Qt</p>
